...
export default function EstoqueInsumo() {
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.subtitle}>Visualize todos os insumos cadastrados e seus saldos em estoque.</div>
      ...
      <div style={styles.card}>
        {insumos.length === 0 ? (
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr>
                {["CODINSU", "Nome", "Descrição", "Característica", "Qtd Estoque", "Status", "Ação"].map(h => (
