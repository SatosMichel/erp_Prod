...
import { Building2, Package, Calculator, ShoppingCart, Activity, UserCheck, TrendingUp, ArrowUpRight, AlertTriangle } from "lucide-react"
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    axios.get("/api/financeiro/dashboard-kpis").then(res => {
      setKpis(res.data)
    }).catch(() => {})
  }, [])
